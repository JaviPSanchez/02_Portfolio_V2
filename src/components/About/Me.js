...
export default function Me() {
  return (
    <div className="grid grid-rows-4 grid-cols-4 gap-6 w-full h-full child:rounded-xl drop-shadow-md">
      ...
      <div className="row-start-2 row-end-4 col-start-3 col-end-5 bg-grey5">
        <VerticalChart />
      </div>
      <div className="row-start-2 row-end-5 col-start-1 col-end-3 bg-grey5">
        <div className="w-5/6 p-10 flex justify-center items-center">
          <Polar />
        </div>
      </div>
      <div className="row-start-1 row-end-2 col-start-3 col-end-4 bg-grey5"></div>
      <div className="row-start-1 row-end-2 col-start-4 col-end-5 bg-grey5"></div>
      <div className="row-start-4 row-end-5 col-start-3 col-end-5 bg-grey5"></div>
    </div>
  );
}
